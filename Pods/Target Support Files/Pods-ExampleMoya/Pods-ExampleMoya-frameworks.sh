...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/IconFormattedDate/IconFormattedDate.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/YNMFormattedDate/YNMFormattedDate.framework"
fi
